...
class EditProfileForm(forms.ModelForm):
    ...
    #         'class':'shadow-sm focus:ring-indigo-500 dark:bg-gray-600 dark:text-white focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md bg-blue-500',
    #         })
    # )
    # last_name = forms.CharField(
    #     widget=forms.TextInput(attrs={
    #         'class':'shadow-sm focus:ring-indigo-500 dark:bg-gray-600 dark:text-white focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md',
    #         })
    # )
    ...
    location = forms.CharField(widget=forms.TextInput(attrs={'class': 'max-w-lg block w-full shadow-sm dark:bg-gray-600 dark:text-white dark:border-dark-third focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md'}), max_length=25, required=False)
    url = forms.URLField(label='Website URL', widget=forms.TextInput(attrs={'class': 'max-w-lg block w-full shadow-sm dark:bg-gray-600 dark:text-white dark:border-dark-third focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md'}), max_length=60, required=False)
